...
const inputNombre = document.getElementById("amigo"); // Input del nombre
const listaHTML = document.getElementById("listaAmigos"); // Lista en pantalla
const resultadoHTML = document.getElementById("resultado"); // Resultado sorteo
const mensajeHTML = document.createElement("p"); // Mensaje dinámico
